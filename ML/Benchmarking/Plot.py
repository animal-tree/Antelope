...
def plot(path, plot_experiments=None, plot_agents=None, plot_suites=None, plot_tasks=None, steps=None,
         write_tabular=False, plot_train=False, title='Antelope', x_axis='Step', verbose=False):
...
def general_plot(data, path, plot_name, palette, make_func, per='Task', title='Antelope', hue='Agent',
