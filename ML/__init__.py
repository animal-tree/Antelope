...
"""
Antelope - A unified framework for intelligence training. A generalist agent by Sam Lerman.
    This file makes it possible to import Antelope as a package or launch it within Python.
"""
import sys
import os
